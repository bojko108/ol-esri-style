        ...
        const filters = [
          {
            ...
            operator: "between",
            value: {
              lowerBound: classBreakInfo.hasOwnProperty("classMinValue")
...
export const readSymbol = async (symbol) => {
  ...
  switch (symbol.type) {
    ...
    case "esriPFS":
      ...
      image.src = `data:${symbol.contentType ?? "image/png"};base64,${
        symbol.imageData
      }`;
      ...
      return new Promise((resolve, reject) => {
        ...
        image.onerror = () =>
          reject(new Error("Failed to load image for esriPFS symbol pattern."));
      });
    default:
