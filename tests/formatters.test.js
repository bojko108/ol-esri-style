...
describe('[src/formatters.js tests]', () => {
  ...
  it('should format string template - "{name}: {value}"', () => {
  ...
  it('should format string template - "{name}: {value}, {description}"', () => {
  ...
  it('should format string template - "$id"', () => {
    const template = '$id';
  ...
  it('should format string template - "$id - {name}"', () => {
